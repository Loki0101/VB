...
export default async function StudentPublicPage({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-300 font-sans selection:bg-indigo-500/30">
      {/* Hero Section */}
      <section className="relative pt-10 pb-20 sm:pt-20 sm:pb-32 overflow-hidden border-b border-zinc-900">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div className="relative group">
              ...
              <div className="relative w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-full border-4 border-[#050505] overflow-hidden bg-zinc-900 shadow-2xl">
                {student.photo ? (
                  <img 
                    src={student.photo} 
                    alt={student.name} 
            ...
            <div className="flex-1 text-center md:text-left pt-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-4 sm:mb-6">
                <GraduationCap className="w-3.5 h-3.5" />
                Featured Student
              </div>
              <h1 className="text-3xl sm:text-5xl md:text-7xl font-black text-white tracking-tight mb-4 uppercase">
                {student.name}
              </h1>
              <div className="flex flex-wrap justify-center md:justify-start gap-3 sm:gap-6 text-zinc-400 text-sm sm:text-base font-medium mb-6 sm:mb-8">
                <div className="flex items-center gap-2 bg-zinc-900/50 backdrop-blur-md px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl border border-zinc-800/50">
              ...
              <p className="text-base sm:text-lg md:text-xl text-zinc-400 leading-relaxed max-w-2xl font-light px-2 md:px-0">
      ...
      {/* Projects Section */}
      <section className="py-20 sm:py-32 bg-[#080808]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
            {student.projects.length === 0 ? (
              ...
              student.projects.map((project, idx) => (
                <div key={idx} className="group bg-zinc-900/30 border border-zinc-800/60 rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden hover:border-indigo-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/5">
                  ...
                  <div className="p-6 sm:p-10">
                    ...
                    <p className="text-sm sm:text-base text-zinc-500 leading-relaxed mb-6 sm:mb-8 line-clamp-3">
                    ...
                    <div className="flex items-center gap-4">
                      {project.link && (
                        <a 
                          ...
                          className="w-full sm:w-auto text-center inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2.5 rounded-full text-sm font-bold transition-all"
                        >
                          View Case Study
